                        ...
                        <div class="row no-gutters">
                            <div class="col-xl-12">
                                <div class="auth-form">
                                    ...
                                    <h2 class="text-center mb-4">Login Clients</h2>
                                    ...
                                    <div class="new-account row mt-3 justify-content-center">
                                        <div class="col-lg-4 col-md-4">
                                            <a href="employee_login.php" class="btn btn-block btn-dark h-auto">Employee</a>
                                        </div>
                                        <div class="col-lg-4 col-md-4">
                                    ...
                                    <div class="text-center mt-3">
                                        <a href="emergency_contact.html" class="text-primary">In need of emergency contact? Click here</a>
                                    </div>
                                </div>
                            </div>
                        </div>
