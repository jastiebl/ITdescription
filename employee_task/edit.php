                            ...
                            <form class="needs-validation" method="POST" novalidate>
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select class="form-select" id="employee" name="employee_id" disabled>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select class="form-select" id="client" name="client_id" disabled>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="taskTitle" name="title" value="<?= $task['title'] ?? '' ?>" disabled>
                                    </div>
                                    <div class="col-md-6 mb-3">
